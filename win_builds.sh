...
(
    cd bin
    rm -f "Chameleon-Win64-${VERSION}.zip"
    rm -f "Chameleon-Win32-${VERSION}.zip"
	tar -a -c -f "Chameleon-Win64-${VERSION}.zip" Win64
    tar -a -c -f "Chameleon-Win32-${VERSION}.zip" Win32
)
